...
# CORRELATION MATRIX: ONE-DAY MODEL WITH PRICE_DEVIATION_MA7
...
print("\n============================================================")
print("CORRELATION MATRIX: ONE-DAY MODEL WITH PRICE_DEVIATION_MA7")
print("============================================================")
print(corr_matrix)
...
plt.title("Correlation matrix - one-day model with price_deviation_ma7")
plt.tight_layout()
plt.savefig("correlation_matrix_one_day_price_deviation.png", dpi=300)
plt.close()

print("\nSaved correlation matrix to:")
print("correlation_matrix_one_day_price_deviation.png")
...
print("\n============================================================")
print("RESULTS: EXACT ONE-DAY WITH PRICE_DEVIATION_MA7")
print("============================================================")
print(results_df)

results_df.to_csv("one_day_price_deviation_results.csv", index=False)

print("\n============================================================")
print("FILES SAVED")
print("============================================================")
print("one_day_price_deviation_results.csv")
print("correlation_matrix_one_day_price_deviation.png")