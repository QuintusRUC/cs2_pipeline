...
# ============================================================
# TARGET CONSTRUCTION: 7-DAY LOG RETURN
# ============================================================
...
# Future price after HORIZON_DAYS:
# price_h = price at t+7 within the same hash_name
df["price_h"] = (
    df.groupby("hash_name")["median_price"]
      .shift(-HORIZON_DAYS)
)
...
# Past 7-day return sum and volatility
# IMPORTANT:
# shift(1) ensures that the rolling window only uses information before date t.
# transform(...) ensures rolling is calculated separately for each hash_name.
df["logret_sum7"] = (
...
# Volume surprise:
# How unusual yesterday's volume was compared to the previous 7-day average
...
print("\nTarget mean:")
print(df["target_logret_h"].mean())

print("\nTarget standard deviation:")
print(df["target_logret_h"].std())
...
# Baseline 2:
# Predict 7-day future return as yesterday's one-day return
...
# Baseline 3:
# Predict 7-day future return as the previous 7-day cumulative return
...
print("\n============================================================")
print("RESULTS: SEVEN-DAY LOG RETURN FORECASTING")
print("============================================================")
print(results_df)

# Save results as CSV
results_df.to_csv("seven_day_logret_results.csv", index=False)

print("\nSaved results to: seven_day_logret_results.csv")